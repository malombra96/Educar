...
public class L4A255_input : MonoBehaviour, IPointerClickHandler
{
    L4A255_managerInput _L4A255_managerInput;
    InputField _input;
    ...
    public void SetStateEmpty(string s)
    {
        ...
        if (Application.isMobilePlatform)
        {
            if (_L4A255_managerInput._lightBox.transform.GetChild(0).GetChild(0).GetComponent<ManagerDisplay>())
                _L4A255_managerInput._lightBox.transform.GetChild(0).GetChild(0).GetComponent<ManagerDisplay>().texto = _input.text;
            else if (_L4A255_managerInput._lightBox.GetComponent<BehaviourKeyBoardAlphabetic>())
                _L4A255_managerInput._lightBox.GetComponent<BehaviourKeyBoardAlphabetic>().texto = _input.text;
        }


        _L4A255_managerInput.SetStateValidarBTN();
    }
    ...
    void Update()
    {
        if (Application.isMobilePlatform && !_L4A255_managerInput._lightBox.activeSelf)
