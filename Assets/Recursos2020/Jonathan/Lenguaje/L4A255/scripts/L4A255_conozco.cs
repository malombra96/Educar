...
public class L4A255_conozco : MonoBehaviour
{
    ...
    [HideInInspector] [Header("Objetos Interactuables")] public List<L4A255_interactividad> _objects;
    string m_PlayerName;
    ...
    public void SetInteraction(bool estado, GameObject objeto)
    {
        ...
        {
            currentInteraction++;
            objeto.GetComponent<L4A255_interactividad>()._state = false;
