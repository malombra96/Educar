...
public class L10A190_keyboard : MonoBehaviour
{
    ControlAudio _controlAudio;

    [Header("Input Texto")] public Text _InputName;
    public GameObject texto;
    private string _name; // name
    public bool _firstWord = true; // State first word
    ...
    private void Update()
    {
        ...
        texto.GetComponent<InputField>().text = _name;
        //print(_name);
    }
