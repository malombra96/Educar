...
public class L7A281_letra : MonoBehaviour
{
    private Text _text;
    ...
    IEnumerator DelayKey(GameObject button)
    {
        ...
        {
            //transform.parent.parent.gameObject.GetComponent<L7A281_keyboard>()._animator.enabled = true;
            //transform.parent.parent.gameObject.GetComponent<L7A281_keyboard>()._animator.Play("KeyBoard_out");// Desactivar Keypad
            transform.parent.parent.gameObject.GetComponent<L7A281_keyboard>().contentTExt.gameObject.transform.parent.GetComponent<L7A281_input>().op = false;
            //transform.parent.parent.gameObject.GetComponent<L7A281_keyboard>()._name = "";
            transform.parent.parent.gameObject.GetComponent<L7A281_keyboard>().gameObject.SetActive(false);
            gameObject.GetComponent<Image>().color = new Color32(237, 120, 7, 255);
            transform.GetChild(0).gameObject.GetComponent<Image>().color = Color.white;
