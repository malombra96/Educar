...
public class L7A281_groupInput : MonoBehaviour
{
    public L7A281_managerInput _L7A281_managerInput;
        ...
        for (int i = 0; i < _inputFields.Count; i++)
        {
            for (int j = 0; j < temporary.Count; j++)
            {
                if (temporary.Contains(_inputFields[i].text))
                {
                    ...
                    {
                        _inputFields[i].GetComponent<L7A281_input>()._isRight = true;
                ...
                {
                    _inputFields[i].GetComponent<L7A281_input>()._isRight = false;
                    break;
                }
