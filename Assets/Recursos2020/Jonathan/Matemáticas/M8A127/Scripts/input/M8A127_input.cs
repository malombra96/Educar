...
public class M8A127_input : MonoBehaviour, IPointerClickHandler
{
    M8A127_managerInput _M8A127_managerInput;
    InputField _input;
    ...
    void Awake()
    {
        ...
        _M8A127_managerInput = FindObjectOfType<M8A127_managerInput>();
    ...
    public void SetStateEmpty(string s)
    {
        ...
        if (Application.isMobilePlatform)
            _M8A127_managerInput._lightBox.transform.GetChild(0).GetChild(0).GetComponent<ManagerDisplay>().texto = _input.text;



        _M8A127_managerInput.SetStateValidarBTN();
    }
    ...
    void Update()
    {
        if (Application.isMobilePlatform && !_M8A127_managerInput._lightBox.activeSelf)
    ...
    public void OnPointerClick(PointerEventData pointerEventData)
    {
        ...
        {
            _M8A127_managerInput._controlAudio.PlayAudio(0);

            ManagerDisplay _managerDisplay = _M8A127_managerInput._lightBox.transform.GetChild(0).GetChild(0).GetComponent<ManagerDisplay>();
            ...
            _M8A127_managerInput._lightBox.SetActive(true);
            _M8A127_managerInput._lightBox.GetComponent<Animator>().Play("NumPad_in");
        }
    }
}
