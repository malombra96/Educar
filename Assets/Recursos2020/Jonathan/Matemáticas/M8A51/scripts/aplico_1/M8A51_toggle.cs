...
public class M8A51_toggle : MonoBehaviour
{
    ControlAudio _controlAudio;
    Toggle _toggle;
    [Header("is Right?")] public bool isRight;
    M8A51_toggleGroup _behaviourToggleGroup;
    M8A51_seleccionar _managerToggle;

    void Start()
    {
        _controlAudio = FindObjectOfType<ControlAudio>();
        _toggle = GetComponent<Toggle>();
        _behaviourToggleGroup = transform.parent.GetComponent<M8A51_toggleGroup>();
        _managerToggle = transform.parent.parent.GetComponent<M8A51_seleccionar>();
    ...
    void SetStateToggle()
    {
        ...
        {
            case M8A51_seleccionar.TypeSelection.onexgroup:
                ...
                if (_toggle.isOn)
                {
                    ...
                    switch (_managerToggle._typeVal)
                    {
                        ...
                        case M8A51_seleccionar.TypeValidation.inmediata:
            ...
            case M8A51_seleccionar.TypeSelection.variousxgroup:
