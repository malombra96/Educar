...
public class M9A74_toggle : MonoBehaviour
{
    ControlAudio _controlAudio;
    Toggle _toggle;
    [Header("is Right?")] public bool isRight;
    public M9A74_toggleGroup _behaviourToggleGroup;
    public M9A74_managerToggle _managerToggle;
    public bool x;
            ...
            case M9A74_managerToggle.TypeSelection.onexgroup:
                ...
                if (_toggle.isOn)
                {
                    ...
                    switch (_managerToggle._typeVal)
                    {
                        ...
                        case M9A74_managerToggle.TypeValidation.inmediata:
