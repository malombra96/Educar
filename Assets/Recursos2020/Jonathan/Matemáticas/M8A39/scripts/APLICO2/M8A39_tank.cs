...
public class M8A39_tank : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (canMove)
        {
            ...
            else
            {
                ...
                //if (transform.rotation.z != forward.z) {
                //    transform.Rotate(new Vector3(transform.rotation.x, transform.rotation.y, forward.z));
                //}
    ...
    private void OnCollisionEnter2D(Collision2D collision)
    {
        ...
        {
            print("sisss");
            player.transform.position = player.GetComponent<M8A39_player2>().initialPosition;
        }
    }
}
