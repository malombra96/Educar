...
public class M6A91_input : MonoBehaviour, IPointerClickHandler
{
    M6A91_managerInput _managerInputField;
    InputField _input;
    ...
    void Awake()
    {
        ...
        _managerInputField = FindObjectOfType<M6A91_managerInput>();
