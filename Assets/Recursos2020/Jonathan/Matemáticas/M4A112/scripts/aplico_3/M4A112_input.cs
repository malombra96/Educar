...
public class M4A112_input : MonoBehaviour, IPointerClickHandler
{
    M4A112_managerA3 _M4A112_managerA3;
    InputField _input;
    ...
    void Awake()
    {
        ...
        _M4A112_managerA3 = FindObjectOfType<M4A112_managerA3>();
    ...
    public void SetStateEmpty(string s)
    {
        ...
        if (Application.isMobilePlatform)
            _M4A112_managerA3._lightBox.transform.GetChild(0).GetChild(0).GetComponent<ManagerDisplay>().texto = _input.text;



        _M4A112_managerA3.SetStateValidarBTN();
    }
    ...
    void Update()
    {
        if (Application.isMobilePlatform && !_M4A112_managerA3._lightBox.activeSelf)
    ...
    public void OnPointerClick(PointerEventData pointerEventData)
    {
        ...
        {
            _M4A112_managerA3._controlAudio.PlayAudio(0);

            ManagerDisplay _managerDisplay = _M4A112_managerA3._lightBox.transform.GetChild(0).GetChild(0).GetComponent<ManagerDisplay>();
            ...
            _M4A112_managerA3._lightBox.SetActive(true);
            _M4A112_managerA3._lightBox.GetComponent<Animator>().Play("NumPad_in");
        }
    }
}
