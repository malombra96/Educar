...
public class M4A112_controller : MonoBehaviour
{
    ...
    void SetSpriteState()
    {
        foreach (var t in _toggle)
        {
            ...
            t.GetComponent<RectTransform>().anchoredPosition = t.isOn
                ? new Vector2(t.GetComponent<RectTransform>().anchoredPosition.x, alturaFinal)
                : new Vector2(t.GetComponent<RectTransform>().anchoredPosition.x, alturaInicial);
        }
    }
}
