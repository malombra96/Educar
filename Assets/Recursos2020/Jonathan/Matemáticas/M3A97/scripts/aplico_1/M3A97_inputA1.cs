...
public class M3A97_inputA1 : MonoBehaviour, IPointerClickHandler
{
    M3A97_managerInputA1 _managerInputField;
    InputField _input;
    ...
    void Awake()
    {
        ...
        _managerInputField = FindObjectOfType<M3A97_managerInputA1>();
