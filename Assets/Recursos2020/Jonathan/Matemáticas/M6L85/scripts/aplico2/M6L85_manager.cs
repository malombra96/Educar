...
public class M6L85_manager : MonoBehaviour
{
    ...
    [Header("Item List")]
    public List<M6L85_drag> _drags;
    public List<M6L85_drop> _drops;

    public List<M6L85_grupo> _groups;
    ...
    void RandomDrag()
    {
        ...
        for (int j = 0; j < _drags.Count; j++)
        {
            ...
            if (statePos != posnew)
            {
                ...
                _drags[posnew] = randomTemp.GetComponent<M6L85_drag>();
            }
        }
    ...
    void ValidarDragDrop()
    {
        ...
        foreach (var drag in _drags)
            if (drag._drop)
                answers.Add(drag.gameObject, (drag._DropRight.Contains(drag._drop.GetComponent<M6L85_drop>())));


        foreach (var drop in _drops)
            if (drop._drag)
                answers.Add(drop.gameObject, (drop._drag.GetComponent<M6L85_drag>()._DropRight.Contains(drop)));
        ...
        foreach (var answer in answers)
        {
            ...
            if (BhDrop)
            {
                ...
                {
                    if (answer.Value)
                        BhDrop._group.GetComponent<M6L85_grupo>()._currentRight++;
                    else
                        BhDrop._group.GetComponent<M6L85_grupo>()._currentWrong++;
                }
            }
    ...
    public void ImmediatelyValidation(M6L85_drag drag, M6L85_drop drop)
    {
    ...
    {
        foreach (var answer in answers)
            if (answer.Key.GetComponent<M6L85_drag>())
                SetSpriteAnswer(answer.Key.GetComponent<Image>(), answer.Value);
    }
    ...
    {
        foreach (var answer in answers)
            if (answer.Key.GetComponent<M6L85_drop>())
                SetSpriteAnswer(answer.Key.GetComponent<Image>(), answer.Value);
    }
    ...
    public void SetPuntaje()
    {
        ...
        foreach (var answer in answers)
        {
            M6L85_drag temp = answer.Key.GetComponent<M6L85_drag>();
        ...
        else
        {
            if (_customValidar == 0)
            {
                if (rights == _drags.Count)
                {
                    ...
                    enunciado.GetComponent<Image>().sprite = enunciado.GetComponent<BehaviourSprite>()._right;
                    enunciado.GetComponent<Image>().SetNativeSize();
                }
                else
                {
    ...
    public void ResetDragDrop()
    {
        if (first)
        {
            enunciado.GetComponent<Image>().sprite = enunciado.GetComponent<BehaviourSprite>()._default;
            enunciado.GetComponent<Image>().SetNativeSize();
            rights = 0;
