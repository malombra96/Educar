...
public class M6A104_managerDrag : MonoBehaviour
{
    public bool first;
    ...
    [Header("Item List")]
    public List<M6A104_drag> _drags;
    public List<M6A104_drop> _drops;

    public List<M6A104_group> _groups;
    ...
    void RandomDrag()
    {
        ...
        for (int j = 0; j < _drags.Count; j++)
        {
            ...
            if (statePos != posnew)
            {
                ...
                _drags[posnew] = randomTemp.GetComponent<M6A104_drag>();
            }
        }
    ...
    void ValidarDragDrop()
    {
        ...
        foreach (var drag in _drags)
            if (drag._drop)
                answers.Add(drag.gameObject, (drag._DropRight.Contains(drag._drop.GetComponent<M6A104_drop>())));
        ...
        {
            var BhDrop = answer.Key.GetComponent<M6A104_drop>();
            ...
            if (BhDrop)
            {
                ...
                {
                    if (answer.Value)
                        BhDrop._group.GetComponent<M6A104_group>()._currentRight++;
                    else
                        BhDrop._group.GetComponent<M6A104_group>()._currentWrong++;
                }
            }
    ...
    {
        foreach (var answer in answers)
            if (answer.Key.GetComponent<M6A104_drag>())
                SetSpriteAnswer(answer.Key.GetComponent<Image>(), answer.Value);
    }
    ...
    {
        foreach (var answer in answers)
            if (answer.Key.GetComponent<M6A104_drop>())
                SetSpriteAnswer(answer.Key.GetComponent<Image>(), answer.Value);
    }
