...
public class M6A104_toggle : MonoBehaviour
{
    ControlAudio _controlAudio;
    Toggle _toggle;
    [Header("is Right?")] public bool isRight;
    M6A104_toggleGroup _behaviourToggleGroup;
    M6A104_managerToggle _managerToggle;
            ...
            case M6A104_managerToggle.TypeSelection.onexgroup:
                ...
                if (_toggle.isOn)
                {
                    ...
                    switch (_managerToggle._typeVal)
                    {
                        ...
                        case M6A104_managerToggle.TypeValidation.inmediata:
