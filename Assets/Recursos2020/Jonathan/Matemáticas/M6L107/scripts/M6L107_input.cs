...
public class M6L107_input : MonoBehaviour, IPointerClickHandler
{
    M6L107_managerInput _M6L107_managerInput;
    InputField _input;
    ...
    void Awake()
    {
        ...
        _M6L107_managerInput = FindObjectOfType<M6L107_managerInput>();
    ...
    public void SetStateEmpty(string s)
    {
        ...
        if (Application.isMobilePlatform)
            _M6L107_managerInput._lightBox.transform.GetChild(0).GetChild(0).GetComponent<ManagerDisplay>().texto = _input.text;



        _M6L107_managerInput.SetStateValidarBTN();
    }
    ...
    void Update()
    {
        if (Application.isMobilePlatform && !_M6L107_managerInput._lightBox.activeSelf)
    ...
    public void OnPointerClick(PointerEventData pointerEventData)
    {
        ...
        {
            _M6L107_managerInput._controlAudio.PlayAudio(0);

            ManagerDisplay _managerDisplay = _M6L107_managerInput._lightBox.transform.GetChild(0).GetChild(0).GetComponent<ManagerDisplay>();
            ...
            _M6L107_managerInput._lightBox.SetActive(true);
            _M6L107_managerInput._lightBox.GetComponent<Animator>().Play("NumPad_in");
        }
    }
}
