...
public class M6L107_managerDrag : MonoBehaviour
{
    public GameObject player;
    public int v,goT,goF;
    public float seg;
    public GameObject vidas,seleccionar;
    public bool first;
    ...
    [Header("Item List")]
    public List<M6L107_drag> _drags;
    public List<M6L107_drop> _drops;

    public List<M6L107_groupDrag> _groups;
    ...
    void RandomDrag()
    {
        ...
        for (int j = 0; j < _drags.Count; j++)
        {
            ...
            if (statePos != posnew)
            {
                ...
                _drags[posnew] = randomTemp.GetComponent<M6L107_drag>();
            }
        }
    ...
    void ValidarDragDrop()
    {
        ...
        foreach (var drag in _drags)
            if (drag._drop)
                answers.Add(drag.gameObject, (drag._DropRight.Contains(drag._drop.GetComponent<M6L107_drop>())));
        ...
        {
            var BhDrop = answer.Key.GetComponent<M6L107_drop>();
            ...
            if (BhDrop)
            {
                ...
                {
                    if (answer.Value)
                        BhDrop._group.GetComponent<M6L107_groupDrag>()._currentRight++;
                    else
                        BhDrop._group.GetComponent<M6L107_groupDrag>()._currentWrong++;
                }
            }
            //print(answer.Key.GetComponent<M6L107_drop>()._group+""+answer.Key + answer);
        }
    ...
    {
        foreach (var answer in answers)
            if (answer.Key.GetComponent<M6L107_drag>())
                SetSpriteAnswer(answer.Key.GetComponent<Image>(), answer.Value);
    }
    ...
    {
        foreach (var answer in answers)
            if (answer.Key.GetComponent<M6L107_drop>())
                SetSpriteAnswer(answer.Key.GetComponent<Image>(), answer.Value);
    }
    ...
    public void SetPuntaje()
    {
     ...
     IEnumerator x (int value,float s) {
