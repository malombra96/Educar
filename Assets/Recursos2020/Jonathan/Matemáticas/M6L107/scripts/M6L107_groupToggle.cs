...
public class M6L107_groupToggle : MonoBehaviour
{
    M6L107_managerToggle _managerSeleccionarToggle;
    ...
    private void Start()
    {
        _managerSeleccionarToggle = transform.parent.GetComponent<M6L107_managerToggle>();
    ...
    int GetSizeCorrect()
    {
        ...
        for (int i = 0; i < transform.childCount; i++)
        {
            bool state = transform.GetChild(i).GetComponent<M6L107_toggle>().isRight;
