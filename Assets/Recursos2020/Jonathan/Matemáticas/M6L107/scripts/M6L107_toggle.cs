...
public class M6L107_toggle : MonoBehaviour
{
    ControlAudio _controlAudio;
    Toggle _toggle;
    [Header("is Right?")] public bool isRight;
    M6L107_groupToggle _behaviourToggleGroup;
    M6L107_managerToggle _managerToggle;

    void Start()
    {
        _controlAudio = FindObjectOfType<ControlAudio>();
        _toggle = GetComponent<Toggle>();
        _behaviourToggleGroup = transform.parent.GetComponent<M6L107_groupToggle>();
        _managerToggle = transform.parent.parent.GetComponent<M6L107_managerToggle>();
        _toggle.onValueChanged.AddListener(delegate { SetStateToggle(); });

        if (_managerToggle._NeedSymbol == M6L107_managerToggle.NeedSymbol.withSymbol)
    ...
    void SetStateToggle()
    {
        ...
        {
            case M6L107_managerToggle.TypeSelection.onexgroup:
                ...
                if (_toggle.isOn)
                {
                    ...
                    switch (_managerToggle._typeVal)
                    {
                        ...
                        case M6L107_managerToggle.TypeValidation.inmediata:
            ...
            case M6L107_managerToggle.TypeSelection.variousxgroup:
        ...
        if (!_managerToggle.reset)
            _managerToggle.StateBtnValidar();
    }
