...
public class M6L101_manager3 : MonoBehaviour
{
    public M6L101_frog frog;
    public GameObject respuestaCorrecta, respuestIncorrecta;
    ...
    public List<M6L101_groupInput> _groupInputField;
    ...
    public void SetStateValidarBTN()
    {
        ...
        foreach (var group in _groupInputField)
        {
            ...
            {
                if (inputField.GetComponent<M6L101_input>()._isEmpty)
                {
                    s = false;
                    break;
                }
    ...
    public void InitializeState()
    {
        foreach (var group in _groupInputField)
        {
            foreach (var inputField in group._inputFields)
            {
                ...
                inputField.GetComponent<M6L101_input>()._isRight = false;
                inputField.GetComponent<M6L101_input>()._isEnabled = true;
    ...
    public void CalificarInputs()
    {
        ...
        for (int i = 0; i < _groupInputField.Count; i++)
        {
            ...
            if (_groupInputField[i]._TipoRespuestas == M6L101_groupInput.TipoRespuestas.individual)
            {
                for (int j = 0; j < _groupInputField[i]._inputFields.Count; j++)
                {
                    ...
                    f.GetComponent<M6L101_input>()._isEnabled = false;

                    bool answer;
                    answer = (f.GetComponent<M6L101_input>().respuestaCorrecta.Contains(f.GetComponent<InputField>().text));
            ...
            else
            {
                ...
                for (int j = 0; j < _groupInputField[i]._inputFields.Count; j++)
                {
                    ...
                    bool answer;
                    answer = f.GetComponent<M6L101_input>()._isRight;
        ...
        if (groupTemp == _groupInputField.Count)
        {
            ...
            respuestIncorrecta.SetActive(true);
    ...
    public void resetAll()
    {
        ...
        frog.GetComponent<RectTransform>().anchoredPosition = frog.inicio;
        respuestIncorrecta.SetActive(false);
