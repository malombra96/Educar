...
public class M6L101_toggle : MonoBehaviour
{
    
    ControlAudio _controlAudio;
    Toggle _toggle;
    [Header("is Right?")] public bool isRight;
    M6L101_grupoToggle _behaviourToggleGroup;
    M6L101_managerToggle _managerToggle;
    public bool mirror;
    ...
    void Start()
    {
        ...
        _behaviourToggleGroup = transform.parent.GetComponent<M6L101_grupoToggle>();
        _managerToggle = transform.parent.parent.GetComponent<M6L101_managerToggle>();
        _toggle.onValueChanged.AddListener(delegate { SetStateToggle(); });

        if (_managerToggle._NeedSymbol == M6L101_managerToggle.NeedSymbol.withSymbol)
            ...
            case M6L101_managerToggle.TypeSelection.onexgroup:
                ...
                if (_toggle.isOn)
                {
                    ...
                    switch (_managerToggle._typeVal)
                    {
                        ...
                        case M6L101_managerToggle.TypeValidation.inmediata:
