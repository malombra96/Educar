...
public class M8A43_manger_2 : MonoBehaviour
{
    public GameObject _Linea;
    public int lineN;
    ...
    void DrawLine()
    {
        //_lines[0].GetComponent<LineRenderer>().Simplify(1);
       ...
       // print(x0 + " / " + x1 + " / " + y0 + " / " + y1);
        ...
        if (dx < 0 || dx > 0)
        {
           ...
           // print(b);
            ...
            if (m == 0)
            {
                _lines[0].GetComponent<LineRenderer>().SetPosition(0, new Vector3(8, y0, 0.1f));
                _lines[0].GetComponent<LineRenderer>().SetPosition(2, new Vector3(-8, y1, 0.1f));
            }
            else if (m < 0 || m > 0)
            {
                ...
                if (y_0 > 7)
                {
                    ...
                    _lines[0].GetComponent<LineRenderer>().SetPosition(0, new Vector3(x_0,7, 0.1f));

                }
                else if (y_0 < -7)
                {

                    _lines[0].GetComponent<LineRenderer>().SetPosition(0, new Vector3(x_1, -7, 0.1f));

                }
                else
                {
                    _lines[0].GetComponent<LineRenderer>().SetPosition(0, new Vector3(8, y_0, 0.1f));
                }

                if (y_1 > 7)
                {

                    _lines[0].GetComponent<LineRenderer>().SetPosition(2, new Vector3(x_0, 7, 0.1f));

                }
                else if (y_1 < -7)
                {

                    _lines[0].GetComponent<LineRenderer>().SetPosition(2, new Vector3(x_1, -7, 0.1f));

                }
                else
                {
                    _lines[0].GetComponent<LineRenderer>().SetPosition(2, new Vector3(-8, y_1, 0.1f));
                }
        ...
        else
        {
            ...
            _lines[0].GetComponent<LineRenderer>().SetPosition(0, new Vector3(x0, 7, 0.1f));
            _lines[0].GetComponent<LineRenderer>().SetPosition(2, new Vector3(x1, -7, 0.1f));
