...
public class M7A119_groupInpu : MonoBehaviour
{
    public M7A119_inputManager _M7A119_inputManager;
        ...
        for (int i = 0; i < _inputFields.Count; i++)
        {
            for (int j = 0; j < temporary.Count; j++)
            {
                if (temporary.Contains(_inputFields[i].text))
                {
                    ...
                    {
                        _inputFields[i].GetComponent<M7A119_input>()._isRight = true;
                ...
                {
                    _inputFields[i].GetComponent<M7A119_input>()._isRight = false;
                    break;
                }
