...
public class M7A119_input : MonoBehaviour, IPointerClickHandler
{
    M7A119_inputManager _M7A119_inputManager;
    InputField _input;
    ...
    void Awake()
    {
        ...
        _M7A119_inputManager = FindObjectOfType<M7A119_inputManager>();
    ...
    public void SetStateEmpty(string s)
    {
        ...
        if (Application.isMobilePlatform)
            _M7A119_inputManager._lightBox.transform.GetChild(0).GetChild(0).GetComponent<ManagerDisplay>().texto = _input.text;



        _M7A119_inputManager.SetStateValidarBTN();
    }
    ...
    void Update()
    {
        if (Application.isMobilePlatform && !_M7A119_inputManager._lightBox.activeSelf)
