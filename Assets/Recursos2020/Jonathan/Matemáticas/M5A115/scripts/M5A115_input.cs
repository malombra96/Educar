...
public class M5A115_input : MonoBehaviour, IPointerClickHandler
{
    M5A115_managerInput _M5A115_managerInput;
    InputField _input;
    ...
    void Awake()
    {
        ...
        _M5A115_managerInput = FindObjectOfType<M5A115_managerInput>();
    ...
    public void SetStateEmpty(string s)
    {
        ...
        if (Application.isMobilePlatform)
            _M5A115_managerInput._lightBox.transform.GetChild(0).GetChild(0).GetComponent<ManagerDisplay>().texto = _input.text;



        _M5A115_managerInput.SetStateValidarBTN();
    }
    ...
    void Update()
    {
        if (Application.isMobilePlatform && !_M5A115_managerInput._lightBox.activeSelf)
    ...
    public void OnPointerClick(PointerEventData pointerEventData)
    {
        ...
        {
            _M5A115_managerInput._controlAudio.PlayAudio(0);

            ManagerDisplay _managerDisplay = _M5A115_managerInput._lightBox.transform.GetChild(0).GetChild(0).GetComponent<ManagerDisplay>();
            ...
            _M5A115_managerInput._lightBox.SetActive(true);
            _M5A115_managerInput._lightBox.GetComponent<Animator>().Play("NumPad_in");
        }
    }
}
