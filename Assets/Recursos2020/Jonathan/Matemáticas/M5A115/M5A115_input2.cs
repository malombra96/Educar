...
public class M5A115_input2 : MonoBehaviour, IPointerClickHandler
{
    M5A115_managerInput2 _M5A115_managerInput2;
    InputField _input;
    ...
    void Awake()
    {
        ...
        _M5A115_managerInput2 = FindObjectOfType<M5A115_managerInput2>();
    ...
    public void SetStateEmpty(string s)
    {
        ...
        if (Application.isMobilePlatform)
            _M5A115_managerInput2._lightBox.transform.GetChild(0).GetChild(0).GetComponent<ManagerDisplay>().texto = _input.text;



        _M5A115_managerInput2.SetStateValidarBTN();
    }
    ...
    void Update()
    {
        if (Application.isMobilePlatform && !_M5A115_managerInput2._lightBox.activeSelf)
    ...
    public void OnPointerClick(PointerEventData pointerEventData)
    {
        ...
        {
            _M5A115_managerInput2._controlAudio.PlayAudio(0);

            ManagerDisplay _managerDisplay = _M5A115_managerInput2._lightBox.transform.GetChild(0).GetChild(0).GetComponent<ManagerDisplay>();
            ...
            _M5A115_managerInput2._lightBox.SetActive(true);
            _M5A115_managerInput2._lightBox.GetComponent<Animator>().Play("NumPad_in");
        }
    }
}
