...
public class M5A115_managerInput2 : MonoBehaviour
{
    public bool ultimo;
    public M5A115_general2 general2;
    ...
    public List<M5A115_grupoInput2> _groupInputField;
    ...
    public void SetStateValidarBTN()
    {
        ...
        foreach (var group in _groupInputField)
        {
            ...
            {
                if (inputField.GetComponent<M5A115_input2>()._isEmpty)
                {
                    s = false;
                    break;
                }
    ...
    public void InitializeState()
    {
        foreach (var group in _groupInputField)
        {
            foreach (var inputField in group._inputFields)
            {
                ...
                inputField.GetComponent<M5A115_input2>()._isRight = false;
                inputField.GetComponent<M5A115_input2>()._isEnabled = true;
