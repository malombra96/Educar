...
public class M06L090_BehaviourDropDown : MonoBehaviour
{
    M06L090_ManagerDropDown _managerDropDown;
    ...
    void Start()
    {
        ...
        _managerDropDown = FindObjectOfType<M06L090_ManagerDropDown>();
    ...
    void GetValueCurrent(int n)
    {
        if (!reset)
        {
            ...
            _managerDropDown.SetStateValidarBTN();
        }
    }
}
