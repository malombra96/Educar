...
public class M06A089_Toggle : MonoBehaviour
{
    ControlAudio _controlAudio;
    Toggle _toggle;
    [Header("is Right?")] public bool isRight;
    M06A089_GroupToggle _behaviourToggleGroup;
    M06A089_ManagerToggle _managerToggle;

    void Start()
    {
        _controlAudio = FindObjectOfType<ControlAudio>();
        _toggle = GetComponent<Toggle>();
        _behaviourToggleGroup = transform.parent.GetComponent<M06A089_GroupToggle>();
        _managerToggle = transform.parent.parent.GetComponent<M06A089_ManagerToggle>();
        _toggle.onValueChanged.AddListener(delegate{SetStateToggle();}); 

        if(_managerToggle._NeedSymbol == M06A089_ManagerToggle.NeedSymbol.withSymbol)
            ...
            case M06A089_ManagerToggle.TypeSelection.onexgroup:
                ...
                if (_toggle.isOn)
                {
                    ...
                    switch (_managerToggle._typeVal)
                    {
                        ...
                        case M06A089_ManagerToggle.TypeValidation.inmediata:
                    ...
                    _behaviourToggleGroup.SetJoystick();
