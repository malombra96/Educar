...
public class M07L120_ManagerPopUp : MonoBehaviour
{
    [Header("Backgrounds")] public Sprite[] _backgrounds = new Sprite[2];
    ...
    void SetElementActive(Toggle select)
    {
        ...
        if (select.isOn)
        {
            ...
            GetComponent<Image>().sprite = _toggle.IndexOf(select) > 2? _backgrounds[1] : _backgrounds[0];
        }   
        else
        {
