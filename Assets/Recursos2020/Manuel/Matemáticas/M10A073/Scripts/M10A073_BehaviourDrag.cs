...
public class M10A073_BehaviourDrag : MonoBehaviour, IBeginDragHandler,IDragHandler, IEndDragHandler, IDropHandler, IPointerClickHandler
{
    M10A073_ManagerDragDrop _managerDragDrop;
    ...
    [Tooltip("Arrastre aquí los drop correctos")] [Header("Correct Drop")] public List<M10A073_BehaviourDrop> _DropRight; 
    ...
    private void Awake()
    {
        ...
        _managerDragDrop = FindObjectOfType<M10A073_ManagerDragDrop>();
    ...
    public void OnEndDrag(PointerEventData eventData)
    {
        ...
        {    
            ...
            else
            {
                ...
                if(ItsInfinite && _managerDragDrop._OperatingMethod == M10A073_ManagerDragDrop.OperatingMethod.Create)
                    CreateDrag();
            }
        }
        else
        {
            ...
            UpdateCurrentPosition();
            SetSpriteState(false);
            GetComponent<M10A073_BehaviourDrag>().swap = false;
        }
    ...
    public void OnDrop(PointerEventData eventData)
    {
        ...
        if (other.GetComponent<M10A073_BehaviourDrag>() && _managerDragDrop._OperatingMethod != M10A073_ManagerDragDrop.OperatingMethod.Create)
        {
    ...
    public void OnPointerClick(PointerEventData eventData)
    {
        ...
        if(_drop)
        {
            _drop.GetComponent<M10A073_BehaviourDrop>()._drag = null;
            _drop = null;
        }

        if(_managerDragDrop._OperatingMethod == M10A073_ManagerDragDrop.OperatingMethod.Create)
        {
    ...
    {
        other.GetComponent<M10A073_BehaviourDrag>().swap = true; // Estado de intercambio 
        Vector2 a = other.GetComponent<M10A073_BehaviourDrag>()._currentPos;
    ...
    public void SwapDefaultPosition(GameObject other)
    {
        ...
        Vector2 x = other.GetComponent<M10A073_BehaviourDrag>()._defaultPos;
        other.GetComponent<M10A073_BehaviourDrag>()._defaultPos = _defaultPos;
        _defaultPos = x;
    }
    ...
    void SwapDrag(GameObject other)
    {
        ...
        GameObject m = other.GetComponent<M10A073_BehaviourDrag>()._drop;
        GameObject n = _drop;
        
        if(m)
            other.GetComponent<M10A073_BehaviourDrag>()._drop.GetComponent<M10A073_BehaviourDrop>()._drag = other;

        if(n)
            _drop.GetComponent<M10A073_BehaviourDrop>()._drag = gameObject;
    ...
    {
        GameObject x = other.GetComponent<M10A073_BehaviourDrag>()._drop;
        other.GetComponent<M10A073_BehaviourDrag>()._drop = _drop;
        _drop = x;
    ...
    {
        if(_managerDragDrop._OperatingMethod == M10A073_ManagerDragDrop.OperatingMethod.Match)
        {
            int x = other.GetComponent<M10A073_BehaviourDrag>()._row;
            other.GetComponent<M10A073_BehaviourDrag>()._row = this._row;
            this._row = x;
        }
    ...
    {
        bool x = other.GetComponent<M10A073_BehaviourDrag>().inDrop;
        other.GetComponent<M10A073_BehaviourDrag>().inDrop = this.inDrop;
        this.inDrop = x;
    }
    ...
    void InicializatNewDrag(GameObject aux)
    {
        ...
        aux.GetComponent<M10A073_BehaviourDrag>()._defaultPos = aux.GetComponent<RectTransform>().anchoredPosition;
        aux.GetComponent<M10A073_BehaviourDrag>().inDrop = false;
        aux.GetComponent<M10A073_BehaviourDrag>().swap = false;
        aux.GetComponent<M10A073_BehaviourDrag>()._drop = null;
        aux.GetComponent<M10A073_BehaviourDrag>().ItsInfinite = true;
