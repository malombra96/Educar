...
public class M06A087_BehaviourDrag : MonoBehaviour, IBeginDragHandler,IDragHandler, IEndDragHandler, IDropHandler, IPointerClickHandler
{
    ...
    [Tooltip("Arrastre aquí los drop correctos")] [Header("Correct Drop")] public List<M06A087_BehaviourDrop> _DropRight; 
    ...
    public void OnEndDrag(PointerEventData eventData)
    {
        ...
        {    
            ...
            else
            {
                ...
                if(ItsInfinite && _managerDragDrop._OperatingMethod == M06A087_ManagerDD.OperatingMethod.Create)
                    CreateDrag();
            }
        }
        else
        {
            ...
            UpdateCurrentPosition();
            SetSpriteState(false);
            GetComponent<M06A087_BehaviourDrag>().swap = false;
        }
    ...
    public void OnDrop(PointerEventData eventData)
    {
        ...
        if (other.GetComponent<M06A087_BehaviourDrag>() && _managerDragDrop._OperatingMethod != M06A087_ManagerDD.OperatingMethod.Create)
        {
    ...
    public void OnPointerClick(PointerEventData eventData)
    {
        ...
        if(_drop)
        {
            _drop.GetComponent<M06A087_BehaviourDrop>()._drag = null;
            _drop = null;
        }

        if(_managerDragDrop._OperatingMethod == M06A087_ManagerDD.OperatingMethod.Create)
        {
    ...
    {
        other.GetComponent<M06A087_BehaviourDrag>().swap = true; // Estado de intercambio 
        Vector2 a = other.GetComponent<M06A087_BehaviourDrag>()._currentPos;
    ...
    public void SwapDefaultPosition(GameObject other)
    {
        ...
        Vector2 x = other.GetComponent<M06A087_BehaviourDrag>()._defaultPos;
        other.GetComponent<M06A087_BehaviourDrag>()._defaultPos = _defaultPos;
        _defaultPos = x;
    }
    ...
    void SwapDrag(GameObject other)
    {
        ...
        GameObject m = other.GetComponent<M06A087_BehaviourDrag>()._drop;
        GameObject n = _drop;
        
        if(m)
            other.GetComponent<M06A087_BehaviourDrag>()._drop.GetComponent<M06A087_BehaviourDrop>()._drag = other;

        if(n)
            _drop.GetComponent<M06A087_BehaviourDrop>()._drag = gameObject;
    ...
    {
        GameObject x = other.GetComponent<M06A087_BehaviourDrag>()._drop;
        other.GetComponent<M06A087_BehaviourDrag>()._drop = _drop;
        _drop = x;

        SwapDefaultPosition(other);

        _managerDragDrop._weightSelect.text = other.name.Split('_')[1];
    }
    ...
    {
        bool x = other.GetComponent<M06A087_BehaviourDrag>().inDrop;
        other.GetComponent<M06A087_BehaviourDrag>().inDrop = this.inDrop;
        this.inDrop = x;
    }
    ...
    void InicializatNewDrag(GameObject aux)
    {
        ...
        aux.GetComponent<M06A087_BehaviourDrag>()._defaultPos = aux.GetComponent<RectTransform>().anchoredPosition;
        aux.GetComponent<M06A087_BehaviourDrag>().inDrop = false;
        aux.GetComponent<M06A087_BehaviourDrag>().swap = false;
        aux.GetComponent<M06A087_BehaviourDrag>()._drop = null;
        aux.GetComponent<M06A087_BehaviourDrag>().ItsInfinite = true;
