...
public class M06A087_GroupToggle : MonoBehaviour
{
    M06A087_ManagerToggle _managerSeleccionarToggle;
    ...
    private void Start()
    {
        _managerSeleccionarToggle = transform.parent.GetComponent<M06A087_ManagerToggle>();
    ...
    int GetSizeCorrect()
    {
        ...
        for (int i = 0; i < transform.childCount; i++)
        {
            bool state = transform.GetChild(i).GetComponent<M06A087_BehaviourToggle>().isRight;
