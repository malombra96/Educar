...
public class M03A098_Drag : MonoBehaviour, IBeginDragHandler,IDragHandler, IEndDragHandler/* , IDropHandler */, IPointerClickHandler
{
    ...
    [Tooltip("Arrastre aquí los drop correctos")] [Header("Correct Drop")] public List<M03A098_Drop> _DropRight; 
    ...
    public void OnEndDrag(PointerEventData eventData)
    {
        ...
        {    
            ...
            else
            {
                ...
                if(ItsInfinite && _managerDragDrop._OperatingMethod == M03A098_ManagerDragDrop.OperatingMethod.Create)
                    CreateDrag();
            }
        }
        else
        {
            ...
            UpdateCurrentPosition();
            SetSpriteState(false);
            GetComponent<M03A098_Drag>().swap = false;
        }
...
/*     public void OnDrop(PointerEventData eventData)
    {
        ...
        if (other.GetComponent<M03A098_Drag>() && _managerDragDrop._OperatingMethod != M03A098_ManagerDragDrop.OperatingMethod.Create)
        {
    ...
    public void OnPointerClick(PointerEventData eventData)
    {
        ...
        if(_drop)
        {
            _drop.GetComponent<M03A098_Drop>()._countDrag--;
            _drop = null;
        }
            
        GetComponent<RectTransform>().SetParent(_managerDragDrop._parentDrags);
    ...
    {
        other.GetComponent<M03A098_Drag>().swap = true; // Estado de intercambio 
        Vector2 a = other.GetComponent<M03A098_Drag>()._currentPos;
    ...
    public void SwapDefaultPosition(GameObject other)
    {
        ...
        Vector2 x = other.GetComponent<M03A098_Drag>()._defaultPos;
        other.GetComponent<M03A098_Drag>()._defaultPos = _defaultPos;
        _defaultPos = x;
    }
...
/*     ///Intercambia el objeto drag asociado a los drop
    void SwapDrag(GameObject other)
    {
        ...
        GameObject m = other.GetComponent<M03A098_Drag>()._drop;
        GameObject n = _drop;
        
        if(m)
            other.GetComponent<M03A098_Drag>()._drop.GetComponent<M03A098_Drop>()._drag = other;

        if(n)
            _drop.GetComponent<M03A098_Drop>()._drag = gameObject;
    ...
    {
        GameObject x = other.GetComponent<M03A098_Drag>()._drop;
        other.GetComponent<M03A098_Drag>()._drop = _drop;
        _drop = x;
    ...
    {
        bool x = other.GetComponent<M03A098_Drag>().inDrop;
        other.GetComponent<M03A098_Drag>().inDrop = this.inDrop;
        this.inDrop = x;
    } */
    ...
    void InicializatNewDrag(GameObject aux)
    {
        ...
        aux.GetComponent<M03A098_Drag>()._defaultPos = aux.GetComponent<RectTransform>().anchoredPosition;
        aux.GetComponent<M03A098_Drag>().inDrop = false;
        aux.GetComponent<M03A098_Drag>().swap = false;
        aux.GetComponent<M03A098_Drag>()._drop = null;
        aux.GetComponent<M03A098_Drag>().ItsInfinite = true;
