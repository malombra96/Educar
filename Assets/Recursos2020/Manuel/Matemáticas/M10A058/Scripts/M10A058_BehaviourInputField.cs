...
using System.Linq;
public class M10A058_BehaviourInputField : MonoBehaviour, IPointerClickHandler
{
    M10A058_ManagerInputField _managerInputField;
    InputField _input;

    [Header("Color BG")]public Color32 colorFondoInicial;
    ...
    void Update()
    {
        if(Application.isMobilePlatform && _isMath && !_managerInputField._lightBox.activeSelf )
