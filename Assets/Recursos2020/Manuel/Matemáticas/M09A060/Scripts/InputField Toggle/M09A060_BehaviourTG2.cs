...
public class M09A060_BehaviourTG2 : MonoBehaviour
{
    M09A060_ManagerST2 _managerSeleccionarToggle;
    ...
    private void Start()
    {
        _managerSeleccionarToggle = transform.parent.GetComponent<M09A060_ManagerST2>();
    ...
    int GetSizeCorrect()
    {
        ...
        for (int i = 0; i < transform.childCount; i++)
        {
            bool state = transform.GetChild(i).GetComponent<M09A060_BehaviourT2>().isRight;
