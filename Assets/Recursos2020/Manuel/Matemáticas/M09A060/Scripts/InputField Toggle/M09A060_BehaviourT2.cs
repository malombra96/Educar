...
public class M09A060_BehaviourT2 : MonoBehaviour
{
    ControlAudio _controlAudio;
    Toggle _toggle;
    [Header("is Right?")] public bool isRight;
    M09A060_BehaviourTG2 _behaviourToggleGroup;
    M09A060_ManagerST2 _managerToggle;

    void Start()
    {
        _controlAudio = FindObjectOfType<ControlAudio>();
        _toggle = GetComponent<Toggle>();
        _behaviourToggleGroup = transform.parent.GetComponent<M09A060_BehaviourTG2>();
        _managerToggle = transform.parent.parent.GetComponent<M09A060_ManagerST2>();
        _toggle.onValueChanged.AddListener(delegate{SetStateToggle();}); 

        if(_managerToggle._NeedSymbol == M09A060_ManagerST2.NeedSymbol.withSymbol)
    ...
    void SetStateToggle()
    {
        ...
        {
            case M09A060_ManagerST2.TypeSelection.onexgroup:
                ...
                if (_toggle.isOn)
                {
                    ...
                    switch (_managerToggle._typeVal)
                    {
                        ...
                        case M09A060_ManagerST2.TypeValidation.inmediata:
            ...
            case M09A060_ManagerST2.TypeSelection.variousxgroup:
