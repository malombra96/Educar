...
public class M09A095_Drag : MonoBehaviour, IBeginDragHandler,IDragHandler, IEndDragHandler, IDropHandler, IPointerClickHandler
{
    ...
    [Tooltip("Arrastre aquí los drop correctos")] [Header("Correct Drop")] public List<M09A095_Drop> _DropRight; 
    ...
    [Header("Equivalence")] public Equivalence _equivalence; 
    ...
    public void OnEndDrag(PointerEventData eventData)
    {
        ...
        {    
            ...
            else
            {
                ...
                if(ItsInfinite && _managerDragDrop._OperatingMethod == M09A095_ManagerDD.OperatingMethod.Create)
                    CreateDrag();
            }
        }
        else
        {
            ...
            UpdateCurrentPosition();
            SetSpriteState(false);
            GetComponent<M09A095_Drag>().swap = false;
        }
    ...
    public void OnDrop(PointerEventData eventData)
    {
        ...
        if (other.GetComponent<M09A095_Drag>() && _managerDragDrop._OperatingMethod != M09A095_ManagerDD.OperatingMethod.Create)
        {
    ...
    public void OnPointerClick(PointerEventData eventData)
    {
        ...
        if(_drop)
        {
            _drop.GetComponent<M09A095_Drop>()._drag = null;
            _drop = null;
        }

        if(_managerDragDrop._OperatingMethod == M09A095_ManagerDD.OperatingMethod.Create)
        {
    ...
    {
        other.GetComponent<M09A095_Drag>().swap = true; // Estado de intercambio 
        Vector2 a = other.GetComponent<M09A095_Drag>()._currentPos;
        Quaternion q = other.GetComponent<RectTransform>().localRotation;
        
        other.GetComponent<RectTransform>().anchoredPosition = _currentPos;
        other.GetComponent<RectTransform>().localRotation = GetComponent<RectTransform>().localRotation;

        GetComponent<RectTransform>().anchoredPosition = a;
        GetComponent<RectTransform>().localRotation = q;
    ...
    public void SwapDefaultPosition(GameObject other)
    {
        ...
        Vector2 x = other.GetComponent<M09A095_Drag>()._defaultPos;
        other.GetComponent<M09A095_Drag>()._defaultPos = _defaultPos;
        _defaultPos = x;
    }
    ...
    void SwapDrag(GameObject other)
    {
        ...
        GameObject m = other.GetComponent<M09A095_Drag>()._drop;
        GameObject n = _drop;
        
        if(m)
            other.GetComponent<M09A095_Drag>()._drop.GetComponent<M09A095_Drop>()._drag = other;

        if(n)
            _drop.GetComponent<M09A095_Drop>()._drag = gameObject;
    ...
    {
        GameObject x = other.GetComponent<M09A095_Drag>()._drop;
        other.GetComponent<M09A095_Drag>()._drop = _drop;
        _drop = x;
    ...
    {
        bool x = other.GetComponent<M09A095_Drag>().inDrop;
        other.GetComponent<M09A095_Drag>().inDrop = this.inDrop;
        this.inDrop = x;
    }
    ...
    void InicializatNewDrag(GameObject aux)
    {
        ...
        aux.GetComponent<M09A095_Drag>()._defaultPos = aux.GetComponent<RectTransform>().anchoredPosition;
        aux.GetComponent<M09A095_Drag>().inDrop = false;
        aux.GetComponent<M09A095_Drag>().swap = false;
        aux.GetComponent<M09A095_Drag>()._drop = null;
        aux.GetComponent<M09A095_Drag>().ItsInfinite = true;
