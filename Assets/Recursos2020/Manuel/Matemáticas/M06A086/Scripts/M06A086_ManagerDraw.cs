...
public class M06A086_ManagerDraw : MonoBehaviour,IPointerClickHandler
{
    ...
    {
        if (_A == null && t.GetComponent<M06A086_ToggleDraw>()._startLine)
            CreateLine(t);
        else if(_A != null)
            EndLine(t);
        else 
    ...
    void CreateLine(Toggle t)
    {
        ...
        x.GetComponent<LineRenderer>().SetPosition(0, t.GetComponent<M06A086_ToggleDraw>()._point);
    ...
    void EndLine(Toggle t)
    {
        ...
        {
            _B = t;
            x.GetComponent<LineRenderer>().SetPosition(1, t.GetComponent<M06A086_ToggleDraw>()._point);
    ...
    private void Update()
    {
        if (x != null && _B == null)
        {
            ...
            float z = _A.GetComponent<M06A086_ToggleDraw>()._point.z;
    ...
    void ValidarLines()
    {
        ...
        {
            var x = line.toggle[0].GetComponent<M06A086_ToggleDraw>();
            var y = line.toggle[1].GetComponent<M06A086_ToggleDraw>();
    ...
    {
        var x = _lines[evaluadas].toggle[0].GetComponent<M06A086_ToggleDraw>();
        var y = _lines[evaluadas].toggle[1].GetComponent<M06A086_ToggleDraw>();
