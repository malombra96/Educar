...
public class M08L035_BehaviourToggle : MonoBehaviour
{
    ControlAudio _controlAudio;
    Toggle _toggle;
    [Header("is Right?")] public bool isRight;
    M08L035_BehaviourToggleGroup _behaviourToggleGroup;
    M08L035_ManagerSeleccionarToggle _managerToggle;

    void Start()
    {
        _controlAudio = FindObjectOfType<ControlAudio>();
        _toggle = GetComponent<Toggle>();
        _behaviourToggleGroup = transform.parent.GetComponent<M08L035_BehaviourToggleGroup>();
        _managerToggle = transform.parent.parent.GetComponent<M08L035_ManagerSeleccionarToggle>();
            ...
            case M08L035_ManagerSeleccionarToggle.TypeSelection.onexgroup:
                ...
                if (_toggle.isOn)
                {
                    ...
                    switch (_managerToggle._typeVal)
                    {
                        ...
                        case M08L035_ManagerSeleccionarToggle.TypeValidation.inmediata:
