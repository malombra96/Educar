...
public class M02A110_Toggle : MonoBehaviour
{
    ControlAudio _controlAudio;
    Toggle _toggle;
    [Header("is Right?")] public bool isRight;
    M02A110_GroupToggle _behaviourToggleGroup;
    M02A110_ManagerToggle _managerToggle;

    void Start()
    {
        _controlAudio = FindObjectOfType<ControlAudio>();
        _toggle = GetComponent<Toggle>();
        _behaviourToggleGroup = transform.parent.GetComponent<M02A110_GroupToggle>();
        _managerToggle = transform.parent.parent.GetComponent<M02A110_ManagerToggle>();
        _toggle.onValueChanged.AddListener(delegate{SetStateToggle();}); 

        if(_managerToggle._NeedSymbol == M02A110_ManagerToggle.NeedSymbol.withSymbol)
    ...
    void SetStateToggle()
    {
        ...
        {
            case M02A110_ManagerToggle.TypeSelection.onexgroup:
                ...
                if (_toggle.isOn)
                {
                    ...
                    switch (_managerToggle._typeVal)
                    {
                        ...
                        case M02A110_ManagerToggle.TypeValidation.inmediata:
            ...
            case M02A110_ManagerToggle.TypeSelection.variousxgroup:
