...
public class M02A110_GroupToggle : MonoBehaviour
{
    M02A110_ManagerToggle _managerSeleccionarToggle;
    ...
    private void Start()
    {
        _managerSeleccionarToggle = transform.parent.GetComponent<M02A110_ManagerToggle>();
    ...
    int GetSizeCorrect()
    {
        ...
        for (int i = 0; i < transform.childCount; i++)
        {
            bool state = transform.GetChild(i).GetComponent<M02A110_Toggle>().isRight;
