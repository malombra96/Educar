...
public class M02A110_Drag : MonoBehaviour, IBeginDragHandler,IDragHandler, IEndDragHandler, IDropHandler, IPointerClickHandler
{
    ...
    [Tooltip("Arrastre aquí los drop correctos")] [Header("Correct Drop")] public List<M02A110_Drop> _DropRight; 
    ...
    public void OnEndDrag(PointerEventData eventData)
    {
        ...
        {    
            ...
            else
            {
                ...
                if(ItsInfinite && _managerDragDrop._OperatingMethod == M02A110_ManagerDD.OperatingMethod.Create)
                    CreateDrag();
            }
        }
        else
        {
            ...
            UpdateCurrentPosition();
            SetSpriteState(false);
            GetComponent<M02A110_Drag>().swap = false;
        }
    ...
    public void OnDrop(PointerEventData eventData)
    {
        ...
        if (other.GetComponent<M02A110_Drag>() && _managerDragDrop._OperatingMethod != M02A110_ManagerDD.OperatingMethod.Create)
        {
    ...
    public void OnPointerClick(PointerEventData eventData)
    {
        ...
        if(_drop)
        {
            _drop.GetComponent<M02A110_Drop>()._drag = null;
            _drop = null;
        }

        if(_managerDragDrop._OperatingMethod == M02A110_ManagerDD.OperatingMethod.Create)
        {
    ...
    {
        other.GetComponent<M02A110_Drag>().swap = true; // Estado de intercambio 
        Vector2 a = other.GetComponent<M02A110_Drag>()._currentPos;
    ...
    public void SwapDefaultPosition(GameObject other)
    {
        ...
        Vector2 x = other.GetComponent<M02A110_Drag>()._defaultPos;
        other.GetComponent<M02A110_Drag>()._defaultPos = _defaultPos;
        _defaultPos = x;
    }
    ...
    void SwapDrag(GameObject other)
    {
        ...
        GameObject m = other.GetComponent<M02A110_Drag>()._drop;
        GameObject n = _drop;
        
        if(m)
            other.GetComponent<M02A110_Drag>()._drop.GetComponent<M02A110_Drop>()._drag = other;

        if(n)
            _drop.GetComponent<M02A110_Drop>()._drag = gameObject;
    ...
    {
        GameObject x = other.GetComponent<M02A110_Drag>()._drop;
        other.GetComponent<M02A110_Drag>()._drop = _drop;
        _drop = x;
    ...
    {
        bool x = other.GetComponent<M02A110_Drag>().inDrop;
        other.GetComponent<M02A110_Drag>().inDrop = this.inDrop;
        this.inDrop = x;
    }
    ...
    void InicializatNewDrag(GameObject aux)
    {
        ...
        aux.GetComponent<M02A110_Drag>()._defaultPos = aux.GetComponent<RectTransform>().anchoredPosition;
        aux.GetComponent<M02A110_Drag>().inDrop = false;
        aux.GetComponent<M02A110_Drag>().swap = false;
        aux.GetComponent<M02A110_Drag>()._drop = null;
        aux.GetComponent<M02A110_Drag>().ItsInfinite = true;
