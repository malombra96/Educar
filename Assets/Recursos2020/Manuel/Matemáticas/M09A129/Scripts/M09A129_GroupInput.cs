...
public class M09A129_GroupInput : MonoBehaviour
{
    [Header("Manager")] public M09A129_ManagerInput _managerInputField;
        ...
        for (int i = 0; i < _inputFields.Count; i++)
        {
            for (int j = 0; j < temporary.Count; j++)
            {
                if (temporary.Contains(_inputFields[i].text))
                {
                    ...
                    {
                        _inputFields[i].GetComponent<M09A129_Input>()._isRight = true;
                ...
                {
                    _inputFields[i].GetComponent<M09A129_Input>()._isRight = false;
                    break;
                }   
