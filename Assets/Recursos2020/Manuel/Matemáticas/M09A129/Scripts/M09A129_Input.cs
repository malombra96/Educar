...
public class M09A129_Input : MonoBehaviour,IPointerClickHandler
{
    M09A129_ManagerInput _managerInputField;
    InputField _input;
    ...
    void Awake()
    {
        ...
        _managerInputField = FindObjectOfType<M09A129_ManagerInput>();
