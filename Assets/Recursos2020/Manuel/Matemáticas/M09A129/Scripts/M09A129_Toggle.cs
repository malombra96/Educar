...
public class M09A129_Toggle : MonoBehaviour
{
    public M09A129_ManagerToggle _managerToggle;
    ControlAudio _controlAudio;
    Toggle _toggle;
    [Header("is Right?")] public bool isRight;
    M09A129_GroupToggle _behaviourToggleGroup;
    ...
    void Start()
    {
        ...
        _behaviourToggleGroup = transform.parent.GetComponent<M09A129_GroupToggle>();
    ...
    void SetStateToggle()
    {
        ...
        {
            case M09A129_ManagerToggle.TypeSelection.onexgroup:
                ...
                if (_toggle.isOn)
                {
                    ...
                    switch (_managerToggle._typeVal)
                    {
                        ...
                        case M09A129_ManagerToggle.TypeValidation.inmediata:
            ...
            case M09A129_ManagerToggle.TypeSelection.variousxgroup:
