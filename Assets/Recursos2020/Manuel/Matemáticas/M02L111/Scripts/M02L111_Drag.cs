...
public class M02L111_Drag : MonoBehaviour, IBeginDragHandler,IDragHandler, IEndDragHandler, IDropHandler, IPointerClickHandler
{
    M02L111_ManagerDD _managerDragDrop;
    ...
    [Tooltip("Arrastre aquí los drop correctos")] [Header("Correct Drop")] public List<M02L111_Drop> _DropRight; 
    ...
    private void Awake()
    {
        ...
        _managerDragDrop = FindObjectOfType<M02L111_ManagerDD>();
    ...
    public void OnEndDrag(PointerEventData eventData)
    {
        ...
        {    
            ...
            else
            {
                ...
                if(ItsInfinite && _managerDragDrop._OperatingMethod == M02L111_ManagerDD.OperatingMethod.Create)
                    CreateDrag();
            }
        }
        else
        {
            ...
            UpdateCurrentPosition();
            SetSpriteState(false);
            GetComponent<M02L111_Drag>().swap = false;
        }
    ...
    public void OnDrop(PointerEventData eventData)
    {
        ...
        if (other.GetComponent<M02L111_Drag>() && _managerDragDrop._OperatingMethod != M02L111_ManagerDD.OperatingMethod.Create)
        {
    ...
    public void OnPointerClick(PointerEventData eventData)
    {
        ...
        if(_drop)
        {
            _drop.GetComponent<M02L111_Drop>()._drag = null;
            _drop = null;
        }

        if(_managerDragDrop._OperatingMethod == M02L111_ManagerDD.OperatingMethod.Create)
        {
    ...
    {
        other.GetComponent<M02L111_Drag>().swap = true; // Estado de intercambio 
        Vector2 a = other.GetComponent<M02L111_Drag>()._currentPos;
    ...
    public void SwapDefaultPosition(GameObject other)
    {
        ...
        Vector2 x = other.GetComponent<M02L111_Drag>()._defaultPos;
        other.GetComponent<M02L111_Drag>()._defaultPos = _defaultPos;
        _defaultPos = x;
    }
    ...
    void SwapDrag(GameObject other)
    {
        ...
        GameObject m = other.GetComponent<M02L111_Drag>()._drop;
        GameObject n = _drop;
        
        if(m)
            other.GetComponent<M02L111_Drag>()._drop.GetComponent<M02L111_Drop>()._drag = other;

        if(n)
            _drop.GetComponent<M02L111_Drop>()._drag = gameObject;
    ...
    {
        GameObject x = other.GetComponent<M02L111_Drag>()._drop;
        other.GetComponent<M02L111_Drag>()._drop = _drop;
        _drop = x;
    ...
    {
        if(_managerDragDrop._OperatingMethod == M02L111_ManagerDD.OperatingMethod.Match)
        {
            int x = other.GetComponent<M02L111_Drag>()._row;
            other.GetComponent<M02L111_Drag>()._row = this._row;
            this._row = x;
        }
    ...
    {
        bool x = other.GetComponent<M02L111_Drag>().inDrop;
        other.GetComponent<M02L111_Drag>().inDrop = this.inDrop;
        this.inDrop = x;
    }
    ...
    void InicializatNewDrag(GameObject aux)
    {
        ...
        aux.GetComponent<M02L111_Drag>()._defaultPos = aux.GetComponent<RectTransform>().anchoredPosition;
        aux.GetComponent<M02L111_Drag>().inDrop = false;
        aux.GetComponent<M02L111_Drag>().swap = false;
        aux.GetComponent<M02L111_Drag>()._drop = null;
        aux.GetComponent<M02L111_Drag>().ItsInfinite = true;
