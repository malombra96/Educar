...
public class M02L111_Toggle : MonoBehaviour
{
    ControlAudio _controlAudio;
    Toggle _toggle;
    [Header("is Right?")] public bool isRight;
    M02L111_GroupToggle _behaviourToggleGroup;
    M02L111_ManagerToggle _managerToggle;

    void Start()
    {
        _controlAudio = FindObjectOfType<ControlAudio>();
        _toggle = GetComponent<Toggle>();
        _behaviourToggleGroup = transform.parent.GetComponent<M02L111_GroupToggle>();
        _managerToggle = transform.parent.parent.GetComponent<M02L111_ManagerToggle>();
        _toggle.onValueChanged.AddListener(delegate{SetStateToggle();}); 

        if(_managerToggle._NeedSymbol == M02L111_ManagerToggle.NeedSymbol.withSymbol)
            ...
            case M02L111_ManagerToggle.TypeSelection.onexgroup:
                ...
                if (_toggle.isOn)
                {
                    ...
                    switch (_managerToggle._typeVal)
                    {
                        ...
                        case M02L111_ManagerToggle.TypeValidation.inmediata:
