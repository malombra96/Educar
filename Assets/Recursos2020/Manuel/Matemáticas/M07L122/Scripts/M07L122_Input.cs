...
public class M07L122_Input : MonoBehaviour,IPointerClickHandler
{
    M07L122_Manager _managerInputField;
    InputField _input;
    ...
    void Awake()
    {
        ...
        _managerInputField = FindObjectOfType<M07L122_Manager>();
        ...
        else
        {
            ...
            _input.onEndEdit.AddListener( delegate {AddSymbol(_input.text);});
        }
    ...
    public void SetStateEmpty(string s)
    {
        ...
        StartCoroutine(_managerInputField.GeneralStateValidar());
    }

    void AddSymbol(string s) => _input.text = s+"°"; //s.Concat("°").ToString()
