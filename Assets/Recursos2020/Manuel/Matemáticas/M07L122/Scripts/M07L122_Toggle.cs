...
public class M07L122_Toggle : MonoBehaviour
{
    ControlAudio _controlAudio;
    Toggle _toggle;
    [Header("is Right?")] public bool isRight;
    M07L122_GroupToggle _behaviourToggleGroup;
    M07L122_Manager _managerToggle;

    void Start()
    {
        _controlAudio = FindObjectOfType<ControlAudio>();
        _toggle = GetComponent<Toggle>();
        _behaviourToggleGroup = transform.parent.GetComponent<M07L122_GroupToggle>();
        _managerToggle = transform.parent.parent.GetComponent<M07L122_Manager>();
    ...
    void SetStateToggle()
    {
        ...
        if(!_managerToggle.reset)
            StartCoroutine(_managerToggle.GeneralStateValidar());
    }
