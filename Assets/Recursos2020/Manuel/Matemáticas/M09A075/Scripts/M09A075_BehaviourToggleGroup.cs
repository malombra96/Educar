...
public class M09A075_BehaviourToggleGroup : MonoBehaviour
{
    M09A075_ManagerSeleccionarToggle _managerSeleccionarToggle;
    ...
    private void Start()
    {
        _managerSeleccionarToggle = transform.parent.GetComponent<M09A075_ManagerSeleccionarToggle>();
    ...
    int GetSizeCorrect()
    {
        ...
        for (int i = 0; i < transform.childCount; i++)
        {
            bool state = transform.GetChild(i).GetComponent<M09A075_BehaviourToggle>().isRight;
