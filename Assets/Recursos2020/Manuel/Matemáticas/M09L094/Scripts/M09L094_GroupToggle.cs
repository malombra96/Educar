...
public class M09L094_GroupToggle : MonoBehaviour
{
    M09L094_ManagerToggle _managerSeleccionarToggle;
    ...
    private void Start()
    {
        _managerSeleccionarToggle = transform.parent.GetComponent<M09L094_ManagerToggle>();
    ...
    int GetSizeCorrect()
    {
        ...
        for (int i = 0; i < transform.childCount; i++)
        {
            bool state = transform.GetChild(i).GetComponent<M09L094_Toggle>().isRight;
