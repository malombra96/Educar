...
public class M09L094_Toggle : MonoBehaviour
{
    ControlAudio _controlAudio;
    Toggle _toggle;
    [Header("is Right?")] public bool isRight;
    M09L094_GroupToggle _behaviourToggleGroup;
    M09L094_ManagerToggle _managerToggle;

    void Start()
    {
        _controlAudio = FindObjectOfType<ControlAudio>();
        _toggle = GetComponent<Toggle>();
        _behaviourToggleGroup = transform.parent.GetComponent<M09L094_GroupToggle>();
        _managerToggle = transform.parent.parent.GetComponent<M09L094_ManagerToggle>();
        _toggle.onValueChanged.AddListener(delegate{SetStateToggle();}); 

        if(_managerToggle._NeedSymbol == M09L094_ManagerToggle.NeedSymbol.withSymbol)
    ...
    void SetStateToggle()
    {
        ...
        {
            case M09L094_ManagerToggle.TypeSelection.onexgroup:
                ...
                if (_toggle.isOn)
                {
                    ...
                    switch (_managerToggle._typeVal)
                    {
                        ...
                        case M09L094_ManagerToggle.TypeValidation.inmediata:
            ...
            case M09L094_ManagerToggle.TypeSelection.variousxgroup:
