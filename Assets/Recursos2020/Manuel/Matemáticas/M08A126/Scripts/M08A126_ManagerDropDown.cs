...
public class M08A126_ManagerDropDown : MonoBehaviour
{
    ControlPuntaje _controlPuntaje;
    ControlNavegacion _controlNavegacion;
    [HideInInspector] public ControlAudio _controlAudio;

    [HideInInspector] public List<M08A126_DropDown> _dropdowns;
    ...
    void SetSpriteDropDown(M08A126_DropDown dropDown, bool state)
    {
    ...
    public void ResetManagerDropDown()
    {
        foreach (var dropdown in _dropdowns)
        {
            var bh = dropdown.GetComponent<M08A126_DropDown>();
