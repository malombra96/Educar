...
public class L03A229_Toggle : MonoBehaviour
{
    ControlAudio _controlAudio;
    Toggle _toggle;
    [Header("is Right?")] public bool isRight;
    L03A229_GroupToggle _behaviourToggleGroup;
    L03A229_ManagerToggle _managerToggle;

    void Start()
    {
        _controlAudio = FindObjectOfType<ControlAudio>();
        _toggle = GetComponent<Toggle>();
        _behaviourToggleGroup = transform.parent.GetComponent<L03A229_GroupToggle>();
        _managerToggle = transform.parent.parent.GetComponent<L03A229_ManagerToggle>();
        _toggle.onValueChanged.AddListener(delegate{SetStateToggle();}); 

        SetSpriteToggle(GetComponent<Image>(),false);
    ...
    void SetStateToggle()
    {
        ...
        {
            case L03A229_ManagerToggle.TypeSelection.onexgroup:
                ...
                if (_toggle.isOn)
                {
                    ...
                    switch (_managerToggle._typeVal)
                    {
                        ...
                        case L03A229_ManagerToggle.TypeValidation.inmediata:
            ...
            case L03A229_ManagerToggle.TypeSelection.variousxgroup:
    ...
    {
        image.color = state? _managerToggle._Colselect : _managerToggle._Coldefault;
    }
