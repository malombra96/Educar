...
public class L03A229_GroupToggle : MonoBehaviour
{
    L03A229_ManagerToggle _managerSeleccionarToggle;
    ...
    private void Start()
    {
        _managerSeleccionarToggle = transform.parent.GetComponent<L03A229_ManagerToggle>();
    ...
    int GetSizeCorrect()
    {
        ...
        for (int i = 0; i < transform.childCount; i++)
        {
            bool state = transform.GetChild(i).GetComponent<L03A229_Toggle>().isRight;
