...
public class L11A270_Drag : MonoBehaviour, IBeginDragHandler,IDragHandler, IEndDragHandler, IDropHandler, IPointerClickHandler
{
    ...
    [Tooltip("Arrastre aquí los drop correctos")] [Header("Correct Drop")] public List<L11A270_Drop> _DropRight; 
    ...
    public void OnEndDrag(PointerEventData eventData)
    {
        ...
        {    
            ...
            else
            {
                ...
                if(ItsInfinite && _managerDragDrop._OperatingMethod == L11A270_ManagerDD.OperatingMethod.Create)
                    CreateDrag();
            }
        }
        else
        {
            ...
            UpdateCurrentPosition();
            SetSpriteState(false);
            GetComponent<L11A270_Drag>().swap = false;
        }
    ...
    public void OnDrop(PointerEventData eventData)
    {
        ...
        if (other.GetComponent<L11A270_Drag>() && _managerDragDrop._OperatingMethod != L11A270_ManagerDD.OperatingMethod.Create)
        {
    ...
    public void OnPointerClick(PointerEventData eventData)
    {
        ...
        if(_drop)
        {
            _drop.GetComponent<L11A270_Drop>()._drag = null;
            _drop = null;
        }

        if(_managerDragDrop._OperatingMethod == L11A270_ManagerDD.OperatingMethod.Create)
        {
    ...
    {
        other.GetComponent<L11A270_Drag>().swap = true; // Estado de intercambio 
        Vector2 a = other.GetComponent<L11A270_Drag>()._currentPos;
    ...
    public void SwapDefaultPosition(GameObject other)
    {
        ...
        Vector2 x = other.GetComponent<L11A270_Drag>()._defaultPos;
        other.GetComponent<L11A270_Drag>()._defaultPos = _defaultPos;
        _defaultPos = x;
    }
    ...
    void SwapDrag(GameObject other)
    {
        ...
        GameObject m = other.GetComponent<L11A270_Drag>()._drop;
        GameObject n = _drop;
        
        if(m)
            other.GetComponent<L11A270_Drag>()._drop.GetComponent<L11A270_Drop>()._drag = other;

        if(n)
            _drop.GetComponent<L11A270_Drop>()._drag = gameObject;
    ...
    {
        GameObject x = other.GetComponent<L11A270_Drag>()._drop;
        other.GetComponent<L11A270_Drag>()._drop = _drop;
        _drop = x;
    ...
    {
        bool x = other.GetComponent<L11A270_Drag>().inDrop;
        other.GetComponent<L11A270_Drag>().inDrop = this.inDrop;
        this.inDrop = x;
    }
    ...
    void InicializatNewDrag(GameObject aux)
    {
        ...
        aux.GetComponent<L11A270_Drag>()._defaultPos = aux.GetComponent<RectTransform>().anchoredPosition;
        aux.GetComponent<L11A270_Drag>().inDrop = false;
        aux.GetComponent<L11A270_Drag>().swap = false;
        aux.GetComponent<L11A270_Drag>()._drop = null;
        aux.GetComponent<L11A270_Drag>().ItsInfinite = true;
