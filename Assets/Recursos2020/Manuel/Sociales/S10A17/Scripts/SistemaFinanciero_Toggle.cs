...
public class SistemaFinanciero_Toggle : MonoBehaviour
{
   ControlAudio _controlAudio;
    Toggle _toggle;
    [Header("is Right?")] public bool isRight;
    SistemaFinanciero_GroupToggle _behaviourToggleGroup;
    SistemaFinanciero_ManagerToggle _managerToggle;

    void Start()
    {
        _controlAudio = FindObjectOfType<ControlAudio>();
        _toggle = GetComponent<Toggle>();
        _behaviourToggleGroup = transform.parent.GetComponent<SistemaFinanciero_GroupToggle>();
        _managerToggle = _behaviourToggleGroup._managerSeleccionarToggle;
            ...
            case SistemaFinanciero_ManagerToggle.TypeSelection.onexgroup:
                ...
                if (_toggle.isOn)
                {
                    ...
                    switch (_managerToggle._typeVal)
                    {
                        ...
                        case SistemaFinanciero_ManagerToggle.TypeValidation.inmediata:
