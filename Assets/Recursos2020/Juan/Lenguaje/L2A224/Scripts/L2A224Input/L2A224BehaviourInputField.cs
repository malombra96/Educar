...
public class L2A224BehaviourInputField : MonoBehaviour, IPointerClickHandler
{
    L2A224ManagerInputField _managerInputField;
    InputField _input;
    ...
    void Awake()
    {
        ...
        _managerInputField = FindObjectOfType<L2A224ManagerInputField>();
    ...
    public void OnPointerClick(PointerEventData pointerEventData)
    {
        if (Application.isMobilePlatform && _isEnabled)
        {
            ...
            L2A224BehaviourKeyBoard _managerDisplay = _managerInputField._lightBox.GetComponent<L2A224BehaviourKeyBoard>();
