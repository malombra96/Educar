...
public class L2A225BehaviourToggle : MonoBehaviour
{
    ControlAudio _controlAudio;
    Toggle _toggle;
    [Header("is Right?")] public bool isRight;
    L2A225BehaviourToggleGroup _behaviourToggleGroup;
    L2A225ManagerSeleccionarToggle _managerToggle;

    void Start()
    {
        _controlAudio = FindObjectOfType<ControlAudio>();
        _toggle = GetComponent<Toggle>();
        _behaviourToggleGroup = transform.parent.GetComponent<L2A225BehaviourToggleGroup>();
        _managerToggle = transform.parent.parent.GetComponent<L2A225ManagerSeleccionarToggle>();
        _toggle.onValueChanged.AddListener(delegate { SetStateToggle(); });

        if (_managerToggle._NeedSymbol == L2A225ManagerSeleccionarToggle.NeedSymbol.withSymbol)
    ...
    void SetStateToggle()
    {
        ...
        {
            case L2A225ManagerSeleccionarToggle.TypeSelection.onexgroup:
                ...
                if (_toggle.isOn)
                {
                    ...
                    switch (_managerToggle._typeVal)
                    {
                        ...
                        case L2A225ManagerSeleccionarToggle.TypeValidation.inmediata:
            ...
            case L2A225ManagerSeleccionarToggle.TypeSelection.variousxgroup:
