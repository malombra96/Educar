...
public class L2A225BehaviourInputField : MonoBehaviour,IPointerClickHandler
{
    L2A225ManagerInputField _managerInputField;
    InputField _input;
    ...
    void Awake()
    {
        ...
        _managerInputField = FindObjectOfType<L2A225ManagerInputField>();
    ...
    void Update()
    {
        ...
        if (Application.isMobilePlatform && Text && Text.gameObject.activeSelf)
    ...
    public void OnPointerClick(PointerEventData pointerEventData)
    {
        if (Application.isMobilePlatform/* && _isEnabled*/)
        {
            ...
            L2A225BehaviourKeyBoard _managerDisplay = _managerInputField._lightBox.GetComponent<L2A225BehaviourKeyBoard>();
