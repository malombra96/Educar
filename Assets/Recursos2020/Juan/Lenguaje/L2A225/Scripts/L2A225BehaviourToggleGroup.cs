...
public class L2A225BehaviourToggleGroup : MonoBehaviour
{
    L2A225ManagerSeleccionarToggle _managerSeleccionarToggle;
    ...
    private void Start()
    {
        _managerSeleccionarToggle = transform.parent.GetComponent<L2A225ManagerSeleccionarToggle>();
    ...
    int GetSizeCorrect()
    {
        ...
        for (int i = 0; i < transform.childCount; i++)
        {
            bool state = transform.GetChild(i).GetComponent<L2A225BehaviourToggle>().isRight;
