...
public class L3A232BehaviourGroupInputField : MonoBehaviour
{
        ...
        for (int i = 0; i < _inputFields.Count; i++)
        {
            for (int j = 0; j < temporary.Count; j++)
            {
                if (temporary.Contains(_inputFields[i].text))
                {
                    ...
                    {
                        _inputFields[i].GetComponent<L3A232BehaviourInputField>()._isRight = true;
                ...
                {
                    _inputFields[i].GetComponent<L3A232BehaviourInputField>()._isRight = false;
                    break;
                }
