...
public class L10A192BehaviourInputField : MonoBehaviour, IPointerClickHandler
{
    ...
    public void OnPointerClick(PointerEventData pointerEventData)
    {
        if (Application.isMobilePlatform && _isEnabled)
        {
            ...
            L10A192BehaviourKeyBoard _managerDisplay = _managerInputField._lightBox.GetComponent<L10A192BehaviourKeyBoard>();

            _managerDisplay._contadorWords = _input.text.Length;
            _managerDisplay._name = _input.text;
