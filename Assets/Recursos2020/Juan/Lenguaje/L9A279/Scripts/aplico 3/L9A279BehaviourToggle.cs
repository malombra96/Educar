...
public class L9A279BehaviourToggle : MonoBehaviour
{
    ControlAudio _controlAudio;
    Toggle _toggle;
    [Header("is Right?")] public bool isRight;
    L9A279BehaviourToggleGroup _behaviourToggleGroup;
    L9A279ManagerSeleccionarToggle _managerToggle;
    ...
    void Start()
    {
        ...
        _behaviourToggleGroup = transform.parent.GetComponent<L9A279BehaviourToggleGroup>();
        _managerToggle = transform.parent.parent.GetComponent<L9A279ManagerSeleccionarToggle>();
        _toggle.onValueChanged.AddListener(delegate { SetStateToggle(); });

        if (_managerToggle._NeedSymbol == L9A279ManagerSeleccionarToggle.NeedSymbol.withSymbol)
    ...
    void SetStateToggle()
    {
            ...
            case L9A279ManagerSeleccionarToggle.TypeSelection.onexgroup:
                ...
                if (_toggle.isOn)
                {
                    ...
                    switch (_managerToggle._typeVal)
                    {
                        ...
                        case L9A279ManagerSeleccionarToggle.TypeValidation.inmediata:
        ...
        _managerToggle.posicionTablero();
