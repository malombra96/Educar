...
public class M6A103BehaviourToggleGroup : MonoBehaviour
{
    M6A103ManagerSeleccionarToggle _managerSeleccionarToggle;
    ...
    private void Start()
    {
        _managerSeleccionarToggle = transform.parent.GetComponent<M6A103ManagerSeleccionarToggle>();
    ...
    int GetSizeCorrect()
    {
        ...
        for (int i = 0; i < transform.childCount; i++)
        {
            bool state = transform.GetChild(i).GetComponent<M6A103BehaviourToggle>().isRight;
