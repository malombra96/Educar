...
public class M8L42BehaviourToggleGroup : MonoBehaviour
{
    M8L42ManagerSeleccionarToggle _managerSeleccionarToggle;
    ...
    private void Start()
    {
        _managerSeleccionarToggle = transform.parent.GetComponent<M8L42ManagerSeleccionarToggle>();
    ...
    int GetSizeCorrect()
    {
        ...
        for (int i = 0; i < transform.childCount; i++)
        {
            bool state = transform.GetChild(i).GetComponent<M8L42BehaviourToggle>().isRight;
