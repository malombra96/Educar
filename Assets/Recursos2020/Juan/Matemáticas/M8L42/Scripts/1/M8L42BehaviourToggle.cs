...
public class M8L42BehaviourToggle : MonoBehaviour
{
    ControlAudio _controlAudio;
    Toggle _toggle;
    [Header("is Right?")] public bool isRight;
    M8L42BehaviourToggleGroup _behaviourToggleGroup;
    M8L42ManagerSeleccionarToggle _managerToggle;

    void Start()
    {
        _controlAudio = FindObjectOfType<ControlAudio>();
        _toggle = GetComponent<Toggle>();
        _behaviourToggleGroup = transform.parent.GetComponent<M8L42BehaviourToggleGroup>();
        _managerToggle = transform.parent.parent.GetComponent<M8L42ManagerSeleccionarToggle>();
    ...
    void SetStateToggle()
    {
        ...
        {
            case M8L42ManagerSeleccionarToggle.TypeSelection.onexgroup:
                ...
                if (_toggle.isOn)
                {
                    ...
                    switch (_managerToggle._typeVal)
                    {
                        ...
                        case M8L42ManagerSeleccionarToggle.TypeValidation.inmediata:
            ...
            case M8L42ManagerSeleccionarToggle.TypeSelection.variousxgroup:
