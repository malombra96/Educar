...
public class M10A8BehaviourToggle : MonoBehaviour
{
    ControlAudio _controlAudio;
    Toggle _toggle;
    [Header("is Right?")] public bool isRight;
    M10A8BehaviourToggleGroup _behaviourToggleGroup;
    M10A8ManagerSeleccionarToggle _managerToggle;

    void Start()
    {
        _controlAudio = FindObjectOfType<ControlAudio>();
        _toggle = GetComponent<Toggle>();
        _behaviourToggleGroup = transform.parent.GetComponent<M10A8BehaviourToggleGroup>();
        _managerToggle = transform.parent.parent.GetComponent<M10A8ManagerSeleccionarToggle>();
        _toggle.onValueChanged.AddListener(delegate { SetStateToggle(); });

        if (_managerToggle._NeedSymbol == M10A8ManagerSeleccionarToggle.NeedSymbol.withSymbol)
    ...
    void SetStateToggle()
    {
        ...
        {
            case M10A8ManagerSeleccionarToggle.TypeSelection.onexgroup:
                ...
                if (_toggle.isOn)
                {
                    ...
                    switch (_managerToggle._typeVal)
                    {
                        ...
                        case M10A8ManagerSeleccionarToggle.TypeValidation.inmediata:
            ...
            case M10A8ManagerSeleccionarToggle.TypeSelection.variousxgroup:
