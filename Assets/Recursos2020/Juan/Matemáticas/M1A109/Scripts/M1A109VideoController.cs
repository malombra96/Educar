...
{
     public class M1A109VideoController : MonoBehaviour
     {
         #region Fields
        ...
        public void PlayWebGL(string video)
        {
        ...
        public void Restart()
        {
            VideoPresenter v = GetComponent<VideoPresenter>();
            Seek(0);
            Pause();
            //v.PlayPause.sprite = v.Play;
            //v.Timeline.Position = 0;
