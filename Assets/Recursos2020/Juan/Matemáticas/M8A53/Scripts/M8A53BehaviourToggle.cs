...
public class M8A53BehaviourToggle : MonoBehaviour
{
    ControlAudio _controlAudio;
    Toggle _toggle;
    [Header("is Right?")] public bool isRight;
    M8A53BehaviourToggleGroup _behaviourToggleGroup;
    M8A53ManagerSeleccionarToggle _managerToggle;

    void Start()
    {
        _controlAudio = FindObjectOfType<ControlAudio>();
        _toggle = GetComponent<Toggle>();
        _behaviourToggleGroup = transform.parent.GetComponent<M8A53BehaviourToggleGroup>();
        _managerToggle = transform.parent.parent.GetComponent<M8A53ManagerSeleccionarToggle>();
    ...
    void SetStateToggle()
    {
        ...
        {
            case M8A53ManagerSeleccionarToggle.TypeSelection.onexgroup:
                ...
                if (_toggle.isOn)
                {
                    ...
                    switch (_managerToggle._typeVal)
                    {
                        ...
                        case M8A53ManagerSeleccionarToggle.TypeValidation.inmediata:
            ...
            case M8A53ManagerSeleccionarToggle.TypeSelection.variousxgroup:
