...
public class M0A65BehaviourToggle : MonoBehaviour
{
    ControlAudio _controlAudio;
    Toggle _toggle;
    [Header("is Right?")] public bool isRight;
    M0A65BehaviourToggleGroup _behaviourToggleGroup;
    M0A65ManagerSeleccionarToggle _managerToggle;

    void Start()
    {
        _controlAudio = FindObjectOfType<ControlAudio>();
        _toggle = GetComponent<Toggle>();
        _behaviourToggleGroup = transform.parent.GetComponent<M0A65BehaviourToggleGroup>();
        _managerToggle = transform.parent.parent.GetComponent<M0A65ManagerSeleccionarToggle>();
            ...
            case M0A65ManagerSeleccionarToggle.TypeSelection.onexgroup:
                ...
                if (_toggle.isOn)
                {
                    ...
                    switch (_managerToggle._typeVal)
                    {
                        ...
                        case M0A65ManagerSeleccionarToggle.TypeValidation.inmediata:
