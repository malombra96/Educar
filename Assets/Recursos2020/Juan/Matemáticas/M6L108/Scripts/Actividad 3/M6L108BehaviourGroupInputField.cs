...
public class M6L108BehaviourGroupInputField : MonoBehaviour
{
    M6L108ManagerInputField _managerInputField;
    ...
    void Awake()
    {
        _managerInputField = FindObjectOfType<M6L108ManagerInputField>();
        ...
        for (int i = 0; i < _inputFields.Count; i++)
        {
            for (int j = 0; j < temporary.Count; j++)
            {
                if (temporary.Contains(_inputFields[i].text))
                {
                    ...
                    {
                        _inputFields[i].GetComponent<M6L108BehaviourInputField>()._isRight = true;
                ...
                {
                    _inputFields[i].GetComponent<M6L108BehaviourInputField>()._isRight = false;
                    break;
                }
