...
public class BehaviourDrag : MonoBehaviour, IBeginDragHandler,IDragHandler, IEndDragHandler, IDropHandler, IPointerClickHandler
{
    ...
    [Tooltip("Arrastre aquí los drop correctos")] [Header("Correct Drop")] public List<BehaviourDrop> _DropRight; 
    ...
    public void OnEndDrag(PointerEventData eventData)
    {
        ...
        {    
            ...
            else
            {
                ...
                if(ItsInfinite && _managerDragDrop._OperatingMethod == ManagerDragDrop.OperatingMethod.Create)
                    CreateDrag();
            }
        }
        else
    ...
    public void OnDrop(PointerEventData eventData)
    {
        ...
        if (other.GetComponent<BehaviourDrag>() && _managerDragDrop._OperatingMethod != ManagerDragDrop.OperatingMethod.Create)
        {
    ...
    public void OnPointerClick(PointerEventData eventData)
    {
        ...
        if(_drop)
        {
            _drop.GetComponent<BehaviourDrop>()._drag = null;
            _drop = null;
        }

        if(_managerDragDrop._OperatingMethod == ManagerDragDrop.OperatingMethod.Create)
        {
    ...
    void SwapDrag(GameObject other)
    {
        ...
        if(m)
            other.GetComponent<BehaviourDrag>()._drop.GetComponent<BehaviourDrop>()._drag = other;

        if(n)
            _drop.GetComponent<BehaviourDrop>()._drag = gameObject;
