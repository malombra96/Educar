...
public class BehaviourInputField : MonoBehaviour,IPointerClickHandler
{
    ManagerInputField _managerInputField;
    InputField _input;
    ...
    void Awake()
    {
        ...
        _managerInputField = FindObjectOfType<ManagerInputField>();
    ...
    public void OnPointerClick(PointerEventData pointerEventData)
    {
        if (Application.isMobilePlatform && _isEnabled)
        {
            ...
            {
                if (!_managerInputField._lightBox.activeSelf)
                {
                    ...
                    if (!_managerInputField._lightBox.GetComponent<BehaviourKeyBoardAlphabetic>()._isFirstTime)
                    {
                        _managerInputField._lightBox.GetComponent<Animator>().Play("KeyBoard_inV2");
                        StartCoroutine(_managerInputField._lightBox.GetComponent<BehaviourKeyBoardAlphabetic>().DelayForDisableAnimator(2));
                    }
                }
            }
        }
